...
public class GameLoop {
	...
	public void play(UserInterface userInterface,
		...
		do {
			...
			if(multiGameContinuation.shouldReportStatus()) {
				userInterface.inform(multiGameContinuation.report());
			}
		} while (!multiGameContinuation.shouldStopPlaying());
	}
	
	private Result playSingleGame(UserInterface userInterface, InterfaceModifier interfaceModifier, ThrowTranslator throwTranslator) throws IOException {
		...
		return player1Throw.play(player2Throw);
	}
