...
public class MultiGameTest {
	...
	public void firstToThreeWithPlayerTwoWinningTwoGames() throws Exception {
		...
		String expectedOutput = "Player 1 Name: " +
								...
								"Record: 0-1" + System.getProperty("line.separator") +
								"[R]ock, [P]aper, or [S]cissors? " +
								"[R]ock, [P]aper, or [S]cissors? " +
								"Kenny Wins!" + System.getProperty("line.separator") +
								"Record: 0-2" + System.getProperty("line.separator") +
								"[R]ock, [P]aper, or [S]cissors? " +
								"[R]ock, [P]aper, or [S]cissors? " +
								"Kenny Wins!" + System.getProperty("line.separator") +
								"Final Record: 0-3" + System.getProperty("line.separator");
	...
	public void firstToTwoWithPlayerOneWinningOneGamesAndPlayerTwoWinningOneGame() throws Exception {
		...
		String expectedOutput = "Player 1 Name: " +
								...
								"Record: 1-0" + System.getProperty("line.separator") +
								"[R]ock, [P]aper, or [S]cissors? " +
								"[R]ock, [P]aper, or [S]cissors? " +
								"Kenny Wins!" + System.getProperty("line.separator") +
								"Record: 1-1" + System.getProperty("line.separator") +
								"[R]ock, [P]aper, or [S]cissors? " +
								"[R]ock, [P]aper, or [S]cissors? " +
								"Amos Wins!" + System.getProperty("line.separator") + 
								"Final Record: 2-1" + System.getProperty("line.separator");
	...
	@Test
	public void firstToTwoIsNotAlteredByTies() throws Exception {
		String input = "Amos\nKenny\nS\nP\nR\nP\nR\nR\nR\nR\nS\nP\n";
		String expectedOutput = "Player 1 Name: " +
								"Player 2 Name: " +
								"[R]ock, [P]aper, or [S]cissors? " +
